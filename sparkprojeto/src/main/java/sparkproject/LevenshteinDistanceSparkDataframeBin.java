...
public class LevenshteinDistanceSparkDataframeBin {

    private static final String DATASET_PATH = "C:\\Users\\joaov\\git\\textao.avro";
    ...
    public static void main(String[] args) {
        SparkSession spark = SparkSession
            .builder()
            .appName("LevenshteinDistanceSparkDataframeAvro")
            .master("local[*]")
        ...
        // Read the dataset as a DataFrame using 'avro' format
        Dataset<Row> linesDF = spark.read().format("avro").load(DATASET_PATH).toDF("line");
